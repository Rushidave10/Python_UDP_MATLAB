...
msg_port1021 = weights_and_bias('layer1').numpy().astype('double')
msg_port1022 = weights_and_bias('layer2').numpy().astype('double')
msg_port1023 = weights_and_bias('layer3').numpy().astype('double')
